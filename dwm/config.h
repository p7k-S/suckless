...
static const Key keys[] = {
    ...
    TAGKEYS(                        XK_c,                      2)
    TAGKEYS(                        XK_g,                      3)
    { 0,                            XK_Print,  spawn,          SHCMD("/home/pavel/.config/suckless/scripts/no_col_icn/screenshot.sh") },
    ...
    { 0, XF86XK_MonBrightnessUp,               spawn,          SHCMD("light -A 5 && ~/.config/suckless/scripts/no_col_icn/brightness.sh") },
    { 0, XF86XK_MonBrightnessDown,             spawn,          SHCMD("light -U 5 && ~/.config/suckless/scripts/no_col_icn/brightness.sh") },
